...
//        }
    ...
    // COMPLETED (8) Create a method that will get the user's preferred location and execute your new AsyncTask and call it loadWeatherData
        private void loadWeatherData(){
            String pLocation = SunshinePreferences.getPreferredWeatherLocation(this);
            new FetchWeatherTask().execute(pLocation);
        }
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPostExecute(String[] data){
            //for every weatherString in data, append it to mWeatherTextView plus some new lines
            for (String weatherString : data) {
