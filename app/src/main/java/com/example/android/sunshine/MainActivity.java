...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) { //if the id of the item clicked is "action_refresh" aka the button, begin re-loading weather data
            mWeatherTextView.setText("");//make blank
            loadWeatherData();//make new weather data
            return true;
        }
